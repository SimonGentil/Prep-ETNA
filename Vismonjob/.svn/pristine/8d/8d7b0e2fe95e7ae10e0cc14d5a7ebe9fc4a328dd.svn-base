            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                session_start();
                    if (isset ($_SESSION[email]))
                    {
                        ...
                        $bdr = $message->rowCount();
                    echo '<ul class="nav navbar-nav navbar-right">
                            <li role="presentation">
                                <a href="php/messages.php">MESSAGES <span class="badge">'.$bdr.'</span></a>
                            </li>
                            <li>
                                <a class="signup" href="php/moncompte.php">MON COMPTE: '.$donnees[Prenom].'</a>
                            </li>
                            <li>
                                <a type="button" href="php/deconnexion.php">SE DECONNECTER</a>
                            </li>
                        </ul>';
                    }
                    else
        ...
        <div class="modal-content">
         ...
         <br>
            ...
            <div class="modal-footer">
                <a href="php/inscription.php" ><button type="button" class="btn btn-lg">S'inscrire</button></a>
